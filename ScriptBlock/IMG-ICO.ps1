...
FFmpeg -v 16 -i V_256x256.bmp -i V_64x64.bmp -i V_48x48.bmp -i V_40x40.bmp -i V_32x32.bmp -i V_24x24.bmp -i V_20x20.bmp -i V_16x16.bmp -map 0 -map 1 -map 2 -map 3 -map 4 -map 5 -map 6 -map 7 -c copy $o
